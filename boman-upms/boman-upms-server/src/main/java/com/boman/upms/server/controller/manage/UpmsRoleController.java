...
import com.boman.upms.rpc.api.UpmsRolePermissionService;
...
public class UpmsRoleController extends BaseController {
     ...
     * @return
     */
    @PostMapping("getActRoles")
    @ResponseBody
    public List<UpmsRole> getActRoles(){
        List<UpmsRole> list = upmsRoleService.selectByExample(new UpmsRoleExample());
        return list;
    }
}
