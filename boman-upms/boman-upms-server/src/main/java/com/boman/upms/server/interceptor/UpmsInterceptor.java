package com.boman.upms.server.interceptor;
...
public class UpmsInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final String ZHENG_OSS_ALIYUN_OSS_POLICY = PropertiesFileUtil.getInstance("boman-oss-client").get("zheng.oss.aliyun.oss.policy");
