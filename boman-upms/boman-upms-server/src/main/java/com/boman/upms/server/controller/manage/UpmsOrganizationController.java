...
public class UpmsOrganizationController extends BaseController {
    ...
    public String create(ModelMap mmap) {
    	List<UpmsOrganization> list = upmsOrganizationService.selectByExample(new UpmsOrganizationExample());
        mmap.addAttribute("upmsSystems", list);
