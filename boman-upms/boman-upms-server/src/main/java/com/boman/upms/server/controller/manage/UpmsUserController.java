...
public class UpmsUserController extends BaseController {
     ...
     * @param roleId
     */
    @GetMapping(value = "getActUser")
    @ResponseBody
    public JSONObject getActUser(
            @RequestParam(required = false, defaultValue = "1", value = "page") int page,
            @RequestParam(required = false, defaultValue = "10", value = "limit") int limit,
            @RequestParam(required = false, defaultValue = "", value = "roleId") String roleId){
        int offset = (page - 1) * limit;
        List<UpmsUser> list = upmsUserService.selectByRoleForOffsetPage(roleId, offset, limit);
        Integer totals = upmsUserService.selectByRoleCount(roleId);
