...
<div class="properties">
    <div class="form-group">
        <label>样式</label> <select class="form-control" name="formClass"
                                  onchange="$(fd.config.containerPanel).attr('class', 'containers fd-view-drag-in '+this.value)">
    ...
    <div class="form-group">
        <label>表单完成提示</label>
        <textarea name="formTip" class="form-control" onchange="$(fd.config.containerPanel).attr('tip', this.value)">$!form.tip</textarea>
    </div>
</div>