...
$(function() {
    ...
    $(document).on('click', '.sub-menu a', function() {
        ...
        $(this).css({'background':'#41a7f6','color':'#fff'});
        $(this).parent().siblings('.sub-menu').find('a').css('background','#3c3c3c');
        $(this).parent().siblings('.sub-menu').find('ul li a').css('background','#3c3c3c');
        $(this).next('ul').find('li a').css('background','#3c3c3c');
        if($(this).next('ul').css('display')=='block'){
            $('.sub-menu ul li a').click(function(){
                $(this).css({'background':'#41a7f6','color':'#fff'});
                $(this).parent('li').siblings('li').find('a').css('background','#3c3c3c');
                $(this).parents('.sub-menu').children('a').css('background','#3c3c3c');
                $(this).parents('.sub-menu').siblings().children('a').css('background','#3c3c3c');
                $(this).parents('.sub-menu').siblings().find('ul li a').css('background','#3c3c3c');
            });
            $(this).parent().siblings('.sub-menu').find('ul').hide();
        }
    });
...
function changeFrameHeight(ifm) {
    ifm.height = document.documentElement.clientHeight - 74;
}
function resizeFrameHeight() {
    $('.tab_iframe').css('height', document.documentElement.clientHeight - 74);
