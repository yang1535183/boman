...
public class RedisUtil {
     ...
     * @param hashValue
     */
    public synchronized static void hset(String key, String hashKey, String hashValue){
        try {
            Jedis jedis = getJedis();
     ...
     * @return
     */
    public synchronized static String hget(String key, String hashKey){
        Jedis jedis = getJedis();
        if (null == jedis) {
            return null;
        }
     ...
     * @return
     */
    public synchronized static boolean hremove(String key, String hashKey){
        Jedis jedis = getJedis();
        if (null == jedis) {
            return true;
        }
